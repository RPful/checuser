    ...
    while True:
        ...
        if option == "1":
            ...
            if verificar_processo(nome_do_script):
                ...
                print("")
                print(f"  {cor_verde}https://megavpnlite.shop/checkuser.php?url=http://{ip}:{porta}/checkUser{cor_reset} ")
                print("")
                print(f" {cor_amarela}Link DtunnelMod abaixo :{cor_reset} ")
                print("")
                print(f"  {cor_verde}https://megavpnlite.shop/checkuser.php?url=http://{ip}:{porta}/dtmod{cor_reset}  ")
                print("")
                print(f" {cor_amarela}Link GltunnelMod abaixo :{cor_reset} ")
                print("")
                print(f"  {cor_verde}https://megavpnlite.shop/checkuser.php?url=http://{ip}:{porta}/gl{cor_reset} ")
                print("")
